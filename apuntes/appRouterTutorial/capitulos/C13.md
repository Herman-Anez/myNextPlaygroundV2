...
Next.js's ESLint configuration includes the eslint-plugin-jsx-a11y
plugin, which helps catch accessibility issues early. For example, this plugin warns if you have images without alt text, use the aria-* and role attributes incorrectly, and more.
...
This configuration uses eslint-config-next/core-web-vitals, which includes the eslint-plugin-jsx-a11y
plugin for catching accessibility issues.
